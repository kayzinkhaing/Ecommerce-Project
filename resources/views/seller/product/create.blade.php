    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('vendor.product.store')}}" method="POST" encrypt="multipart/form-data">
                    @csrf
                    <label for="product_name" class="fw-bold mb-2">Give Name of Your Product</label>
                    <input type="text" class="form-control" name="product_name" placeholder="Lenovo IdealPad 5 Pro">
                   ...
                   <select name="store_id" id="store_id" class="form-control mb-2">
                    ...
                    <input type="text" class="form-control mb-2" name="tax_rate">
